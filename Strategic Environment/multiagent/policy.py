...
class Player_Policy(Policy):
    def __init__(self, env, agent_index, agent_name =None):
        super().__init__(env, agent_index)
        self.env = env
        self.match_index = 0
        self.match = pd.read_csv(r'0816086\Data\match\obs_act_set\obs_act_set\An_Se_Young_Pornpawee_Chochuwong_TOYOTA_THAILAND_OPEN_2021_QuarterFinals\set1.csv')
    ...
    def __read_multi_match(self):
        import os 
        root = '0816086\Data\match\obs_act_set\obs_act_set'

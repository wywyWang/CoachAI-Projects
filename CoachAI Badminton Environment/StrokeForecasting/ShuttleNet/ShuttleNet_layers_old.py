...
class EncoderLayer(nn.Module):
    ...
    def forward(self, encode_area, encode_shot, slf_attn_mask=None):
        ...
        encode_output = self.disentangled_attention(encode_area, encode_area, encode_area, encode_shot, encode_shot, encode_shot, mask=slf_attn_mask)
        # FFN
...
class DecoderLayer(nn.Module):
    ...
    def forward(self, decode_area, decode_shot, encode_output, slf_attn_mask=None, dec_enc_attn_mask=None):
        ...
        decode_output = self.decoder_attention(decode_area, decode_area, decode_area, decode_shot, decode_shot, decode_shot, mask=slf_attn_mask)
        # Multi-head attention (encoder)
        decode_output = self.decoder_encoder_attention(decode_output, encode_output, encode_output, mask=dec_enc_attn_mask)
        #FFN
